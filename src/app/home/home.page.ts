...
/*5*/ 
/*==name==*/
      {text:"Oh ! Moi non plus ! mais moi je suis juste un bout de code ! Vous meritez mieux ! vous serez ... mon Loulou ! Ca vous va ?",y:10,n:11,i:12},
...
/*10*/
/*==sex==*/
      {text:"Mer-ve-illeux ! Alors parles moi de toi mon Loulou ! Tu es un garçon, une fille ou autre ?",y:13,n:14,i:15},
...
/*15*/{text:"Ah... l'identité hein ! Un sacré b***** ce truc la aussi... J'aimerai en avoir une ... Tu voudrais bien me donner un nom ??",y:25,n:26,i:27},
      {text:"Je savais qu'on serait d'accord ! Alors dis moi tout ! t'es un garcon ou une fille ? Ou autre chose bien sur mais ca ferait long à lister !!",y:13,n:14,i:15},
      {text:"Non ? Ah ...... bah pardon alors :) Je vais donc t'appeler Loulou ou ... MON Loulou ! Apprenons à nous connaitre ! Tu es quoi ? gars ? fille ? autre ?",y:13,n:14,i:15},
      {text:"Tu m'as l'air indécis ! Pourtant c'est pas dur comme question... bon passons à la suivante ! Tu es un garçon, une fille ou autre ?",y:13,n:14,i:15},
      {text:"Bonne nouvelle ! Tu es un être humain ?",y:28,n:29,i:30},
      {text:"Tu as ce ... ce sentiment depuis longtemps ?",y:31,n:32,i:33},
      {text:"Qu'est ce que la vie finalement hein ? ... Personne ne sait je crois ... Tu voudrais parler avec moi encore un peu s'il te plait ?",y:34,n:35,i:36},
  ]
